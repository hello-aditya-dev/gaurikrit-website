...
export interface GaurikritCowMarkProps {
  className?: string;
  ariaHidden?: boolean;
}

/**
 * Front-facing cow-head mark set inside a scalloped/floral emblem.
 * Haldi-yellow filled emblem, dark forest-green outline.
 * Compact, iconic, serious (not cartoonish).
 */
export function GaurikritCowMark({
  className,
  ariaHidden = true,
}: GaurikritCowMarkProps) {
  ...
  return (
    ...
    >
      {!isHidden && <title>Gaurikrit cow mark</title>}
      ...
      >
        ...
        <path d="M 60 33 L 60 44" strokeWidth={1.1} opacity={0.55} />
        {/* Forehead bulge definition */}
        <path d="M 54 36 Q 60 38 66 36" strokeWidth={1.1} opacity={0.55} />

        {/* Muzzle band line (separating muzzle from face) */}
        <path d="M 48 70 Q 60 74 72 70" strokeWidth={1.3} opacity={0.75} />

        {/* Mouth */}
        <path d="M 54 80 Q 60 82 66 80" strokeWidth={1.3} opacity={0.75} />
      </g>
