...
export interface IndianCourtyardProps {
  className?: string;
  ariaHidden?: boolean;
}

/**
 * Architectural Indian wall/courtyard section.
 * Limewashed wall with arched opening, small niche, a step.
 * Forest line art. Haldi painted field on part of wall.
 * Plan-elevation feel (architectural minimalism).
 */
export function IndianCourtyard({
  className,
  ariaHidden = true,
}: IndianCourtyardProps) {
  ...
  return (
    ...
    >
      {!isHidden && <title>Indian courtyard wall</title>}
      ...
      <g stroke="var(--forest)" strokeWidth={0.5} opacity={0.18}>
      ...
      <g stroke="var(--forest)" strokeWidth={0.7} opacity={0.4}>
      ...
      <circle cx={252} cy={110} r={5} fill="none" stroke="var(--forest)" strokeWidth={0.8} opacity={0.55} />
      ...
      <g stroke="var(--forest)" strokeWidth={1.1} opacity={0.7}>
