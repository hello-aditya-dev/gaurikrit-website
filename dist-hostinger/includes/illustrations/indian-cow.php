 ...
 * Ported from src/components/illustrations/indian-cow.tsx
 */
// @var string $class Optional CSS class for the root <svg>
$class = $class ?? '';
?>
<svg viewBox="0 0 280 180" xmlns="http://www.w3.org/2000/svg" class="<?= htmlspecialchars($class, ENT_QUOTES) ?>" role="img" aria-hidden="true" preserveAspectRatio="xMidYMid meet" width="100%" height="100%">
  ...
  <g fill="none" stroke="var(--forest)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M 79 160 L 85 160" stroke-width="1.5" />
    <path d="M 101 160 L 107 160" stroke-width="1.5" />
    <path d="M 213 160 L 219 160" stroke-width="1.5" />
    <path d="M 235 160 L 241 160" stroke-width="1.5" />
    ...
    <path d="M 64 110 C 70 115 78 117 86 116" stroke-width="1.4" opacity="0.65" />
    <path d="M 62 107 C 67 112 73 113 80 113" stroke-width="1.3" opacity="0.45" />
    <path d="M 60 104 C 64 108 68 109 74 109" stroke-width="1.2" opacity="0.3" />

    <!-- Hump definition line — front of hump rising from neck -->
    <path d="M 72 56 C 76 54 80 52 84 52" stroke-width="1.4" opacity="0.55" />
    <!-- Hump back slope definition -->
    <path d="M 92 52 C 96 54 100 56 104 58" stroke-width="1.3" opacity="0.4" />

    <!-- Shoulder blade suggestion line -->
    <path d="M 96 80 C 100 90 104 100 104 110" stroke-width="1.2" opacity="0.35" />

    <!-- Tail — long curve from rump down with tuft -->
    <path d="M 252 72 C 258 80 262 95 262 115 C 262 122 260 128 258 132" />
    <!-- Tail tuft -->
    <path d="M 258 130 C 262 132 264 138 262 142" stroke-width="1.3" />
    <path d="M 256 130 C 254 134 254 140 256 144" stroke-width="1.3" />
    <path d="M 260 132 C 264 136 266 142 262 146" stroke-width="1.3" />

    <!-- Eye -->
    <circle cx="42" cy="76" r="1.6" fill="var(--forest)" stroke="none" />
    <!-- Brow suggestion -->
    <path d="M 38 73 C 41 71 45 71 48 73" stroke-width="1.2" opacity="0.55" />

    <!-- Muzzle detail — nostril + mouth line -->
    <circle cx="24" cy="94" r="0.9" fill="var(--forest)" stroke="none" />
    <path d="M 22 99 Q 26 101 30 99" stroke-width="1.2" opacity="0.7" />

    <!-- Subtle ground line -->
    <path d="M 20 164 L 260 164" stroke-width="1" opacity="0.22" />
  </g>
